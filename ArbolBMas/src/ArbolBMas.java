...
public class ArbolBMas {
    ...
    // Eliminar. Eliminación sencilla que no implica fusión de los nodos. (Tarea 2)

    // Recorrido por rango. Muestra los datos correspondientes al rango recuperado. (Tarea 2)
}